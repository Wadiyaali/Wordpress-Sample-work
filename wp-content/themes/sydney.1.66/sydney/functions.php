...
/**
 * Trying to add custom code.. MENU
 */
/*
...
function wpb_adding_scripts() {
	wp_register_script('pushy', get_template_directory_uri() . '/js/pushy.js', array('jquery'),'1.1', true);
...
function wpb_adding_scripts2() {
	wp_register_script('pushymin', get_template_directory_uri() . '/js/pushy.min.js', array('jquery'),'1.1', true);
	wp_enqueue_script('pushymin');
	}
